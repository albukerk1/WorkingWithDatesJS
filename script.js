// Função que retorna o parâmetro Date maior, utilizando operador ternário (`? :`), que é uma forma condicional compacta para expressar a declaração if...else.
